...
<div class="col-md-3">
 ...
 <div class="col-md-12">
 	<div class="col-md-12"><h2>Products & Kits: Add Media Sounds</h2></div>
</div>

        <?php
         echo Form::open(array('addsection' => 'addsounds','class' => 'form-horizontal'));
           ?>
 ...
 <div class="col-md-2">
   ...
   <div class="col-md-10">
    ...
    <option value="etc">etc</option>
         ...
         <div class="form-group">
  <div class="col-md-2">
       <label for="text">Sound Cloud Url:</label>
    </div>
    <div class="col-md-10">
