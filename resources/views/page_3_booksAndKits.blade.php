            ...
            <div class="products-slider-wrap">
                ...
                <div class="products-slider-item card-raised">
                    <div class="card-raised--content text-center">
                        <img src="app/uploads/{!! $task->productImage !!}" class="img-responsive center-block" style="max-height:150px; min-height:150px;"  alt="">
                        <hr class="v-hidden">
...
<div class="page-section products-section">
  <div class="products-section--title">
      <h2 class="font-light font-40">Video / DVDs</h2>
      <hr>
        <hr>

        <div class="products-slider" id="videodvd">
  @foreach($results['videoDvd'] as $task)
            <div class="products-slider-wrap">
                <div class="products-slider-item card-raised">
                    <div class="card-raised--content text-center">
                        <img src="app/uploads/{!! $task->productImage !!}" class="img-responsive center-block" style="max-height:150px; min-height:150px;"   alt="">
