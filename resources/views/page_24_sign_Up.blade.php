                ...
                <div class="card-raised">
                    <div class="card-raised--content">
                        <div class="bg-white rounded bordered padded-30">
                            <form action="">
                                <input type="text" class="so-input" placeholder="First Name">
                                <input type="text" class="so-input" placeholder="Last Name">
                                <input type="email" class="so-input" placeholder="E-mail">
                                <input type="text" class="so-input" placeholder="Password">
                                <input type="text" class="so-input" placeholder="Confirm Password">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"> Sign Up for Newsletter
                                    </label>
                                </div>
                                <button type="submit" class="btn btn-teal btn-block btn-rounded font-21">Sign Up</button>
                            </form>
                            <hr>
