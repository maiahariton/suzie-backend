<footer class="footer">
    ...
    <div class="footer-branding">
        <img src="../assets/img/footer-logo.jpg" class="img-responsive center-block" alt="">
    </div>
...
<script>window.jQuery || document.write('<script src="../../resources/assets/js/vendor/jquery-1.12.0.min.js"><\/script>')</script>
